...
electronics_root = os.path.join(repo_root, 'electronics')
...
def export_jlcpcb(pcb, schematic, alt_fields, release_prefix, no_drc):
...
if __name__ == '__main__':
    ...
    export_jlcpcb(args.pcb, args.assembly_schematic, args.alt_fields, args.release_prefix, args.no_drc)
